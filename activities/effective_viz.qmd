...
```{r}
#| fig-cap: "This is a plot showing how the temperature at 9 am predicts the temperature at 3 pm."
...
#| fig-alt: "This is a density plot of 3pm temperatures in Celcius in Hobart, Uluru, and Wollongong, Australia. Wallongong is most frequently the location with the highest temperature at 3pm, followed by Hobart, and then the Uluru. Link: ____"
...
This graph is fine, except if you have Monochromacy/Achromatopsia. 
...
It shows which cigarette companies made the most money from 2004-2007 globally. 
...
Yes. You can go a bar chart with brand on the x axis and revenue on the y axis, and assign color to brand.
...
I wouldn't have used different colors for every brand. I like that the scale stayed consistent, and the bars are arranged in order of most to least revenue. 
